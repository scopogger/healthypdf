...
class PDFViewer(QScrollArea):
    ...
    def __init__(self, parent=None):
        ...
        self.draw_state = {
            ...
            'brush_size':        4,
            'rect_fill_color':   QColor(Qt.black),   # QColor or None (no fill)
        ...
        try:
            ...
            try:
                ...
                if primitives is not None:
                    ...
                    # Надо переделать: reconstruct ordered list from separate lists
    ...
    def overlay_render(self, new_page: Page):
        ...
        primitives = vec.get("primitives", [])
        if not primitives:
            # Надо переделать хранение strokes/rects отдельно lists
